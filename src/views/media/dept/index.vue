  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="负责人电话" prop="deptPhone">
...
<script>
  import { listMedia, getMedia, delMedia, addMedia, updateMedia, exportMedia } from '@/api/media/dept';
    ...
    methods: {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有科室数据项?', '警告', {
          ...
          return exportMedia(queryParams)
        }).then(response => {
